...
mm.add("(min-width: 769px)", ()=>{
    ...
    marqueeAnimation.to(".marquee-part", {xPercent: -100, repeat: -1, duration: 10, ease: "none"}).totalProgress(0.5)
...
// linea roja//
    ...
    let isScrollingDown = true;
    const marqueeAnimation = gsap.timeline();
    marqueeAnimation.to(".marquee-part", {xPercent: -100, repeat: -1, duration: 10, ease: "none"}).progress(0)
